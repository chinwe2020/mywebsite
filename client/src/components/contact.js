  ...
  const onSubmitForm = async(e) => {
    ...
    return(
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="email" placeholder="Enter email" value={emailAddress} onChange={e => setEmailAddress(e.target.value)} required/>
      ...
      <Form.Group className="mb-3" controlId="formBasicPassword">
        ...
        <Form.Control as="textarea" rows={3} placeholder="Type Message" value={emailMessage} onChange={e => setEmailMessage(e.target.value)} maxLength={700} required/>
        <div className="text-muted">{emailMessage.length}/700 characters</div>
      </Form.Group>
